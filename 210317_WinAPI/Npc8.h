...
public:
	...
	inline void SetIsAliveN8(bool isAlive) { this->N_isAlive = isAlive; }
	inline bool GetIsAliveN8() { return this->N_isAlive; }
	...
	NpcSee8 GetNpcSee8() { return this->N_see; }
};
